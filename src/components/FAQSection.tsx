...
const faqs = [
  {
    ...
    a: `As of today, the national average for Unleaded 91 is approximately ${FALLBACK_PRICES.NSW.ulp91}¢/L in NSW. Diesel averages around ${FALLBACK_PRICES.NSW.diesel}¢/L. Prices vary by state and suburb — use our search tool above to find current prices near you.`,
  },
  {
