        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-accent border border-border rounded-sm pl-10 pr-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
          ...
          <select
            ...
            className="bg-accent border border-border rounded-sm px-4 py-3 text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
          ...
          <button
            ...
            className="bg-primary text-primary-foreground font-semibold px-6 py-3 rounded-sm hover:opacity-90 transition-all"
